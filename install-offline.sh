...
# K8S版本
K8S_VERSION="${K8S_VERSION:-v1.24.8}"
...
# 下载文件
# ansible-docker-v1.24.8-amd64.tgz 68MB
...
mkdir -p /etc/kubernetes/ansible
# 下载文件
# 依赖镜像 ansible-kubernetes-images-v1.24.8-amd64.tgz 1526MB
...
mkdir -p /etc/kubernetes/ansible
# 下载文件
# 安装脚本 ansible-kubernetes-v1.24.8-amd64.tgz 276MB
