...
# 执行脚本
# bash /etc/kubernetes/ansible/ansible-kubernetes-v1.24.8.sh
...
beagle-01   Ready    master   93s   v1.24.8-beagle
beagle-02   Ready    <none>   79s   v1.24.8-beagle
beagle-03   Ready    <none>   79s   v1.24.8-beagle
